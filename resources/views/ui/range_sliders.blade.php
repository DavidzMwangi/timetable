...
@section('style')
    ...
    <!-- Range Slider Css -->
    <link href="{{asset('template/plugins/ion-rangeslider/css/ion.rangeSlider.css')}}" rel="stylesheet" />
    <link href="{{asset('template/plugins/ion-rangeslider/css/ion.rangeSlider.skinFlat.css')}}" rel="stylesheet" />
...
@section('script')
    ...
    <script src="{{asset('template/plugins/ion-rangeslider/js/ion.rangeSlider.js')}}"></script>

    <!-- Custom Js -->
    <script src="{{asset('template/js/admin.js')}}"></script>
    <script src="{{asset('template/js/pages/ui/range-sliders.js')}}"></script>
