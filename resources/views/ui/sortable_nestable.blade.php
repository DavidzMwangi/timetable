...
@section('style')
    ...
    <!-- JQuery Nestable Css -->
    <link href="{{asset('template/plugins/nestable/jquery-nestable.css')}}" rel="stylesheet" />
...
@section('script')
    ...
    <!-- Jquery Nestable -->
    <script src="{{asset('template/plugins/nestable/jquery.nestable.js')}}"></script>

    <!-- Custom Js -->
    <script src="{{asset('template/js/admin.js')}}"></script>
    <script src="{{asset('template/js/pages/ui/sortable-nestable.js')}}"></script>
